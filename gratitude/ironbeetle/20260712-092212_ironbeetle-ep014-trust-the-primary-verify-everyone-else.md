...
**Language:** EN
**Stamp:** 20260712.092212 UDT (the maintainer's clock, carried forward)
...
A primary's word about its own view needing no chain of proof, while everyone else's claim still earns a check, is the same shape as the maintainer's own word inside this practice: trusted outright at the one place decisions are actually made, verified everywhere else before it travels further.

...
- **Marc Andreessen**, for *The Techno-Optimist Manifesto* (a16z, October 16, 2023) — the essay widely read as a foundational text for **effective accelerationism ("e/acc")**, the idea that the deliberate, rapid advance of technology is how humanity builds its way toward abundance.
  - Source: <https://a16z.com/the-techno-optimist-manifesto/>. Following the practice we keep for copyrighted works, this file holds a principles summary in our own words rather than the verbatim text.

---

## Why We Read It Here

the maintainer asked that this proposal's public face read less like a competitor breaking away and more like a contributor joining in — collaborative, radiant, in the open spirit of open source, drawing on the ethical-accelerationist conviction that building good things quickly, in the open, is itself a moral act. The Techno-Optimist Manifesto is the essay that put that conviction into the wider air, so we read it here for the threads worth carrying — and, in the discerning spirit Hickey's *Hammock-Driven Development* asks of us, we name plainly the threads we set down.
...
- **Optimism as a duty, not a mood.** The essay closes on David Deutsch's line — that the future is open rather than predetermined, so we are all responsible for what it holds, and it is our duty to build a better one. This is the thread most worth keeping: the future is authored, not awaited, and building well is how one takes responsibility for it.
- **Technology as a lever — more with less.** Its clearest transferable claim is the oldest one: that new tools let a society do more with less, and that this compounding is where real abundance comes from. This maps directly onto why we measure at all (see Ojjo, and *Measure What Matters*): a lever is only worth pulling if you can see what it moved.
- **The infinite game.** Drawing on James Carse, the essay distinguishes finite games (someone wins, someone loses, then it ends) from infinite games (players collaborate to keep discovering what is possible, and the game never ends). This is the thread that most rewards a collaborative reading: open source at its best is an infinite game, and a contribution offered upstream keeps the game going rather than trying to win it.
- **"Pay it forward."** The essay names the Silicon Valley habit of generosity — helping one another learn and grow, trusting through aligned incentives. Held gently, stripped of its market framing, this is simply the gift: you give because someone gave to you, and the giving is the point.
- **Technology as the ultimate open society.** Its most universalist line is that technology does not care about your origin — anyone with a positive attitude and a cheap laptop can contribute. That is the open-source promise stated plainly, and it is the one we most want our own front door to keep.

## The Threads We Set Down
...
*May we build quickly and build well. May the game we play be the infinite one. And may every fast thing we make still be a safe thing, offered as a gift rather than wielded as a win.*

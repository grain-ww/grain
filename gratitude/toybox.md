...
**Source:** <https://landley.net/toybox/> - **Repository:** <https://github.com/landley/toybox> - **License:** **0BSD**, read from its own `LICENSE` - **Held as:** git submodule at `toybox/`, cloned whole and unmodified - **Living pin:** `b7ec52ac35` (`2026-06-22`) - **Fetched:** `20260905.104613` on the maintainer's word

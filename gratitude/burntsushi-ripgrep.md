...
**Source:** <https://github.com/BurntSushi/ripgrep> - **License:** **Unlicense OR MIT**, dual, read from its own `COPYING` - **Held as:** git submodule at `ripgrep/`, cloned whole and unmodified - **Living pin:** `3fce3b5bb0` (`2026-08-04`) - **Fetched:** `20260905.130819` on the maintainer's word

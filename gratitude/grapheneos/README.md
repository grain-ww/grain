...
- **`install-web.md`** — the WebUSB-based web installer guide, mirrored from `grapheneos.org/install/web`. This is the path [`../../manual/guides/pixel-10a-grapheneos-setup.md`](../../manual/guides/pixel-10a-grapheneos-setup.md) walks, and the one the maintainer actually used to flash the physical Pixel 10a.

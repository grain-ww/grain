...
**Stamp:** `20260821.022912` - **Status:** Mixed -- Living (design decision, the maintainer's word) - **Voice:** Kyri - **Style:** Gauge (see `../context/GAUGE_STYLE.md`)
**Chapter:** G -- Cryptography (the Six-Chapter double-seat)
...
Both are correct. They only conflict because each treats the available oracles as fixed. **the maintainer's word (`20260821`): vendor a second SLH-DSA implementation and keep both.**

...
**Voice:** Kyri
**Status:** Proposed -- awaiting the maintainer's word; **Room:** mixed -- the measurement is checkable, the choice between the two readings is a ruling
...
REDS row `20260909.183200` closed a fleet-wide refusal and left one sentence standing for the maintainer:
...
exactly this choice for the maintainer, and a lap that answers a parked question has answered its own

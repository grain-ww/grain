...
**Voice:** Kyri
**Status:** Vision -- a yonder note that accretes to the Gleaner proposal; the name Gleaner is still proposed (`git grep -il gleaner` reads 0 files at tip `ae8286e`); nothing is built; a build waits on the maintainer's word

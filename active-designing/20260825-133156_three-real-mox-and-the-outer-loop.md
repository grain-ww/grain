...
Three real machines exist today. A a cloud region VPS. A Framework laptop. The macOS host this document
...
does not stall macOS and a cloud provider from finishing a round together -- the cheapest lever is not a
...
**Waits for the maintainer's hand -- named gates, none invented here:**
- Any real Comlink fetch between the three physical machines -- the "Comlink-served" gate
  `mycelium/README.md` already names.
- Provisioning anything new on a cloud region to carry this -- gate 2, `construction/ITINERARY.md` line
  145. Agents author IaC; the maintainer provisions and pays.

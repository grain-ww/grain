...
- **Open on a seat awaiting the maintainer's word:** `%306` (which room moves), `%326` (binding a
...
**Capacity is reported rather than gated on purpose.** Raising a page's bound is the maintainer's word --
...
Three doors open, and each costs something different. Each stays open for the maintainer's word.
...
Which one, and when, is the maintainer's word.

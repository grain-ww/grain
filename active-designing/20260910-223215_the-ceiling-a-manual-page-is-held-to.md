...
sweeps are checkable; the routing-page reading at the end is proposed and waits on the maintainer's word
...
wall, and the wall is the maintainer's.
...
own is a reading of the card, and the card is the maintainer's.

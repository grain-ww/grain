...
**Voice:** Kyri
**Status:** Living, mixed -- the orbit-three reading of the quest that retires ai-jail, measured with its closing proposed; the closing of any survivor named here waits on the maintainer's word
...
Closing any of them changes what a running agent can do, so each is the maintainer's word rather than a

...
**Voice:** Kyri
**Status:** Proposed -- awaiting the maintainer's word on the second half
...
**Half two is the maintainer's word, because it crosses a seated law.** Letting a checkout honour a sibling
...
that default should sit is already on the card as the maintainer's word. This page asks a different

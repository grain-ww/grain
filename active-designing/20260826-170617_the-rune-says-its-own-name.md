...
exactly where it is; the cut discipline is at the tail and waits for the maintainer's word.
...
`../context/LEXICON.md` and the two module renames are one lap each, and both wait for the maintainer.

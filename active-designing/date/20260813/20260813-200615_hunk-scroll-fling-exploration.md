...
**Chapter:** A (Hardware & Right-to-Repair) · **Waymark:** HUNK · rung **HUNK45**
...
- The **served-marketplace module-assembly ruling** (the HUNK39 checkpoint) stays held for the maintainer's word.

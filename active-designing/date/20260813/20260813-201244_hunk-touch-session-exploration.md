...
**Chapter:** A (Hardware & Right-to-Repair) · **Waymark:** HUNK · rung **HUNK46**
...
- The **served-marketplace module-assembly ruling** (HUNK39 checkpoint) stays held for the maintainer's word.

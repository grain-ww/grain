...
**Chapter A** (Hardware & Right-to-Repair) · **waymark HUNK** · **Photos-app journey** · **rung HUNK56**
...
- The **session-that-travels** crux (persist a live editing session content-addressed) still crosses the `pond/apps`↔`brushstroke` assembly-identity seam — held for the maintainer / a design round, unchanged by this rung.

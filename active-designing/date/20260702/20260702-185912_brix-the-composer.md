...
**Stamp:** `20260702.185912` — re-siloed at the maintainer's word; the earlier form (`20260628.120912`) named its teachers in the clean room, and this revision carries the same decisions with the names returned to their own room
...
*Written together by the maintainer and Reya 2; re-siloed with Rio 3.*

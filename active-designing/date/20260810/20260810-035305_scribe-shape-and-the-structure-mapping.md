...
**Status:** Mixed -- Design counsel. the maintainer asked five questions mid-build; this note rules on each with a recommendation, seats nothing irreversibly, and holds the two structural ones for his word.

...
**Kin:** [`the decision wave`](20260815-175524_rye-first-crypto-parity-and-the-decision-wave.md) · `crypto/` (Chapter G) · `context/TAME_GUIDANCE.md` · Kumara identity

Chapter G climbs its crypto primitives in Rye. This brief seats a hash
...
· SHAKE-256** in Rye as Chapter G primitives, parity-checked against **Zig
...
**Verdict (the maintainer's word: "choose the most Lindy path for the 21st century"),
...
**Refined `20260815.191048` on the maintainer's word.** the maintainer rightly pushed back: past
...
Whichever is chosen becomes its own Chapter G design round, built Rye-first with
parity witnesses (std.crypto / reference KATs), TAME-disciplined and audit-ready.
The actual identity keygen and signing with the maintainer's own key stays the **custody
...
2. **Seated:** build **SLH-DSA (SPHINCS+) on SHAKE-256** as a Chapter G round with

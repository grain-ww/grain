...
**Chapter:** Six-Chapter double-seat, Chapter C (Lotus · the creative suite) · waymark **ALES** · rung **ALES221**
...
Software only, purely local — a Sha256 record over in-process bytes, siloed to `lotus/`. It proves an artifact arrived whole, **not who made it** — no signature, no key. A signed carry stays a later rung on the maintainer's word. No real file, no DAC, no acoustic or electrical fact, no network, no funds, no real device. No custody gate.

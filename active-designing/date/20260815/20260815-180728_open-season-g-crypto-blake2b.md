...
Chapter G's promise is a Rye-native, parity-checked crypto library the coming audit
...
populate it is an outward act held on the maintainer's hand (`work-in-progress/archive/20260726-025926_monocypher-submodule-diagnosis.md`).
...
Named semantically — *Chapter G · Cryptography · blake2b* — not a bare-letter ladder
rung. A four-letter waymark for Chapter G is drawn in its own small round under the

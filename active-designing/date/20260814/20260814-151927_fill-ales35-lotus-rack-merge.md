...
**Chapter:** the Six-Chapter double-seat, Chapter C thread (Lotus · the creative suite) · waymark **ALES** · rung **ALES35**
...
This rung stays **purely local** — grafting fixed-array value structs in process. No signature, no key, no socket, no network, no funds, no device. The Kumara-signed carry and the ALES0-wire carry remain later seams on the maintainer's word.

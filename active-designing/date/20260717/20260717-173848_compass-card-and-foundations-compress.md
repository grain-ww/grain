...
- Every dated foundation and context spec on `main`.
- Existing compressors (HAWM · TUBE · PROVEN_SEAT · ENCLOSURE · …).
- `dated_guard` · accrete-never-break · living_docs_lint five duties.
...
| **C3** | Optional LEXICON core Bron card | horizon — the maintainer's word |

## Related

- Docs compression law `20260712-221600`
- Witness habitat silo `20260717-173427`
- Tutorial `manual/tutorials/cursor-and-the-compass.md`

---

*May the card open the rose, and the rose keep its full light on the shelf beneath.*

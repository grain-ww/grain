...
the maintainer’s example home id **`kd`** is the first fixture; schema allows any two lowercase ASCII letters once LULU0 witnesses bounds.
...
1. **Send** SETU5 when the maintainer says send.  

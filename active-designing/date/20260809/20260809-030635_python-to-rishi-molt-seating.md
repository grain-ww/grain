...
**Language:** EN
**Status:** Mixed -- Living — molt seated `20260809.030635` on the maintainer's word · **prep only, no cut**
**Voice:** Riyo
...
## The molt widens: every script speaks Rishi (`20260809.115123`, the maintainer's word)
...
### The match primitive landed (`20260809`, the maintainer's word — "grow the match primitive first")
...
### find, `{n,m}`, and `\b` landed (`20260809`, the maintainer's word — "c2, grow find next")

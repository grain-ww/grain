...
- Seating any of this into `context/TAME_GUIDANCE.md` itself stays gated on the maintainer's word, exactly as the runes-scoping study already named for a heavily-cited canon file.

...
*the maintainer granted word for A-narrow `lane_kvm` after metal parity GREEN. This note retires the Framework night path that reached the host session bus and spawned transient units outside the jail.*

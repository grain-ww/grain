...
**Gate:** the maintainer opened SLC-L3 settlement `182500` — witness runs; no winner crowned in prose.
...
| **Complete** | Both lanes run the same flow; witness scores three axes; recommendation waits on the maintainer |
...
- Crown winner in prose — counsel holds that for the maintainer after witness scores

...
Eight-asks **A4** ordered Open Asks design before broad Linengrow feature debt. SLC-L1 (**152**) and SLC-L2 (**155**) now hold the receipt and carriage layers. This note draws the **first Open Asks lap** so implementation can stay mechanical when the maintainer affirms the edge.
...
## Build Order (after the maintainer affirms edge)

...
candidate passage for the TAME canon, boxed below for the maintainer's word.*

**Stamp:** `20260703.140212` (supplied verbatim by the maintainer)
**Language:** EN
...
the boxed canon passage seats only on the maintainer's word
...
Boxed for the maintainer's word, to sit in the TAME voiced canon beside the bounds discipline:

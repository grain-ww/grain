...
*Form-factor product names seated by the maintainer. Orientation via Sensors stays horizon.*
...
the maintainer chose the macOS / iOS–shaped family (`20260717.183622`):
...
- Some keys wrong — hit boxes are equal columns; paint is uneven label widths
- Font tiny; portrait letterboxing (centered Skate grid, empty top/bottom)

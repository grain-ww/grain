...
*Claude answered the maintainer's Codeberg question and revised the evening sources pin. Verified before answering: Codeberg is canonical; VERSION 26.05 at `492a5102...` (2026-05-29, Christian Helmuth); migration commits remove the GitHub check and retarget docs.*

**Stamp:** `20260712.201802`
**Language:** EN
**Style:** Gauge (see `../../context/GAUGE_STYLE.md`)
**Voice:** Rio 3 recording Claude - the maintainer's clock from the 20:17 paste

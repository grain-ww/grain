...
*the maintainer asked for the thinnest honest lap: one desk reads one `@u32` sample from Rishi argv; the matching fixture desk stays GREEN; Glow still does not tokenize `|=` (bartis). This brief is the implementable plan -- not the GREEN close.*

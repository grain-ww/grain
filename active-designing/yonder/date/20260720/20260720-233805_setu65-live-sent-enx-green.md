...
*the maintainer approved lean A and said kg with the Pixel tethered. Desk armed on a systemd predictable `enx*` name (driver `cdc_ncm`), unicasted the SETU5 framed payload to the USB-tether default gateway on UDP **38503**, and earned **sent**.*

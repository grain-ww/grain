...
`20260725.040520` and listed in `session-logs/CHAPTERS.md`, and a second shape for the same job is
...
script over-applied -- deepening each shelf **header's** own `../CHAPTERS.md`, which the tool writes
...
the room and folding the room is the maintainer's word. That is a gate rather than a red: the number is

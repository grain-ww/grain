...
**Status:** Living design capture -- the self-approved round that opens Chapter C (Lotus)
...
**Kin:** [`the Eight-Chapter double-seat`](date/20260816/20260816-205859_double-seat-expansion-eight-seasons.md) -- Chapter C - [`Lotus, the DAW`](yonder/20260630-014012_lotus-the-daw.md) - idiom twins [`constel/wire.rye`](../constel/wire.rye) (FORA3) - [`mikrophone/wire.rye`](../mikrophone/wire.rye) (DREY1)
...
Chapter C -- **Lotus**, the creative suite -- held zero code. Its one bounded, no-research, no-gate crux is the **basic audio wire shape**: the way a buffer of audio samples reaches the software, proven whole before it can touch a timeline. The Six-Chapter doc names exactly this task ("implement the basic wire shape for XLR - USB-C - guitar") while it *pauses* the audio-interface **hardware** design on the maintainer's word. The wire shape is the software carrier; the hardware is the paused part. So the crux is clean to take, and it opens the season on the same verify-before-trust frame idiom the tree already trusts twice over.

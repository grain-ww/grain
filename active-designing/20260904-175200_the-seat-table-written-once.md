...
**Voice:** Kyri
**Status:** Living charter, mixed -- the seat table is read by live tools and the consolidation plan is a proposal, seated on the maintainer's word `20260904`
...
The six absent seats are the aether fleet. Their trees lived on the Mac and on the a coastal city pier,
and a coastal city was cancelled `20260903`. Six of the nine seats the fleet's own instruments still
...
the maintainer circles it. `launch-claude-chapter.rish` (30 living citers) stays where it is as the

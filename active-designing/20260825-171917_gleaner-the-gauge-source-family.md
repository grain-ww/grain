...
**Voice:** Kyri
**Status:** Vision -- a yonder note, and an **accretion** rather than a new module. It extends the Gleaner proposal with a second source family; if the maintainer parks the Gleaner name, this note parks with it and its contents move to whatever the fetcher is eventually called

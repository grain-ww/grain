...
**Stamp:** `20260907.074815` - **Status:** Booked, mixed -- **the maintainer's word `20260907`**
...
- **Shed-prep prepares; it never cuts.** The Amphora cut stays RED until the maintainer circles it
  (`molt`, `debride`).

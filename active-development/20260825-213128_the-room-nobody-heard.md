...
`tools/gen/chapter/` witnesses still pass, and what does a sing cost?*

Both halves have answers now, and the second one changed what the first one means.

## What was measured, and on what

All figures below: this pier (a cloud region, AMD 4 vCPU / 8 GB, `nproc` 4), `20260825`, EDT, tree at
...
| Reading | Count |
|---|---|
| Tracked `*_witness.rish` under `tools/gen/chapter/` | **298** |

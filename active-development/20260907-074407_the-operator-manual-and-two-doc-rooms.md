...
**Asked by:** the maintainer, `20260907` -- *update docs-geode with all of these operating user manual
...
for the maintainer's word rather than landing on measurement alone.

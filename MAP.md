...
Root [`LICENSE-MIT`](LICENSE-MIT) - [`LICENSE-APACHE`](LICENSE-APACHE) - [`LICENSE-CC-BY`](LICENSE-CC-BY) still name copyright **the maintainer** -- a living hold until the maintainer names a copyright rewrite. Dated the maintainer / the maintainer testimony elsewhere stays; this map does not restyle the license files.

...
#
# On the maintainer's word the ladder folded (the 20260820.131713 design call, option A):
...
#
# Three rungs later the carry stood at 17,997, and the maintainer's word opened option B:
...
# rule is a guard of its own now: tools/fixtures/c/caravan_ladder_reach_scan.sh.
#

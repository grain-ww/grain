...
#
#   sh tools/fixtures/e/equinox_seat_map_scan.sh
#
...
echo "seat_map_shred=the-maintainer_gated"
...
echo "story=seat_110_spent>map_corrected>112_close_choir_proposed>bundle_crossing_mode>shred_the-maintainer_gated>fork_waiting"

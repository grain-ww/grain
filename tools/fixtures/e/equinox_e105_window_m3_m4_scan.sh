...
#
#   sh tools/fixtures/e/equinox_e105_window_m3_m4_scan.sh
#
...
OLDNESS=tools/fixtures/o/oldness_census_scan.sh
H1=tools/fixtures/r/radiant_h1_fence_scan.sh
...
# A FLOOR ON AN ADVANCING REVISION (`20260909.001500`, the maintainer's word). A metric revision advances as
# the metric improves -- it reads i10 today -- so an equality reds on the improvement it should
# welcome. A revision BELOW i9 is a regression behind what this equinox proved, and still refuses.

#!/usr/bin/env sh
# pond_metal_close_preflight.sh -- automated checks before the maintainer's interactive metal close.
...
echo "Next (the maintainer, on GNOME): pond/bin/drawn-terminal — type, idle ~1 min, fill past ceiling, :quit."

...
# session-logs/README.md, whose rows fold when its logs fold and whose log fold runs on the maintainer's
...
# THE ONE NAMED EXEMPTION (REDS %295, seated on the maintainer's word 20260828). The Mind launcher pair

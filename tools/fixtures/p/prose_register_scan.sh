...
# derivation question standing on the maintainer's word since `20260910.175434`.
#
...
# tighter is the maintainer's word, and holding it to Field costs that word nothing.
#

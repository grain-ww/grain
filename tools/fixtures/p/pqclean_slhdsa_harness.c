// tools/fixtures/p/pqclean_slhdsa_harness.c -- the vendored PQClean (vendor/pqclean, CC0-1.0), compiled and asked for its OWN
...
// discipline requires. Chapter G (Cryptography -- Rye-native, audit-ready).
//
...
// doubled-oracle discipline the whole crypto/ shelf rests on. the maintainer's word (`20260821`) answers that trade rather than picking a

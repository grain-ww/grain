#!/bin/sh
# tools/fixtures/u/upstream_shape_scan.sh -- read the shape of the ordering remote before rebasing onto it.
#
...
# the working tree.
#
#   sh tools/fixtures/u/upstream_shape_scan.sh                  # read the live shape and gate
#   sh tools/fixtures/u/upstream_shape_scan.sh prove-rewritten  # reflog absent: replays everything
#   sh tools/fixtures/u/upstream_shape_scan.sh prove-forkpoint  # reflog present: replays only ours
#   sh tools/fixtures/u/upstream_shape_scan.sh prove-ordinary   # a shared history must NOT refuse
#   sh tools/fixtures/u/upstream_shape_scan.sh prove-shallow    # a shallow clone must NOT refuse
#
...
REMOTE="${UPSTREAM_SHAPE_REMOTE:-acme-owner}"

#!/bin/sh
# tools/fixtures/r/room_bound_scan.sh -- how many dated files stand flat in each room.
#
...
#
# USAGE
#   sh tools/fixtures/r/room_bound_scan.sh          # the roster, at the seated bound
#   sh tools/fixtures/r/room_bound_scan.sh 2        # a smaller bound, for proving the RED path
#
...
#
# THE SHELF BOUND, seated 20260828 on the maintainer's word (the change to the seated law the paragraph

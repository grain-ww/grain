...
#
# the maintainer read six commits of one Caravan refactoring arc on 20260822 and still had to ask what
...
#
#   sh tools/fixtures/m/mechanism_sentence_scan.sh
#   sh tools/fixtures/m/mechanism_sentence_scan.sh prove-red
#
...
# The control corpus is a fixtures SUBDIRECTORY, which the letter fold leaves in place.
CONTROL=$_fd_root/tools/fixtures/mechanism_sentence_control/metaphor_only_control.txt
WINDOW=${WINDOW:-40}
CEILING=${CEILING:-21}

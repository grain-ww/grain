...
entry ### 107. Equinox e103 Class A refine + window_min: fascia metric i7 excludes four honest the fund-turn anchors; fall baseline is window_min; fascia 92→100.

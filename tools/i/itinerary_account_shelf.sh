...
#
# THE ASKS LEAVING THE CARD, SAID OUT LOUD. A ship writes its question for the maintainer inside its own
...
# invariant: this reports and never refuses -- answering an ask is the maintainer's word, and a writer that

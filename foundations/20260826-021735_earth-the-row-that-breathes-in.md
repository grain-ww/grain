...
**Voice:** Kyri
**Status:** Living -- the earth row's threshold page, read first on its rota lap; seated 20260826 on the maintainer's word -- **mixed room**: the rota mechanics and the seated palette are checkable, the planetary frame is vision
**Kin:** [`20260826-014901_the-panchanga.md`](20260826-014901_the-panchanga.md) -- `kyri/receipt.rye` (the two palettes) -- [`20260905-154954_the-clock-and-the-mark.md`](20260905-154954_the-clock-and-the-mark.md) -- [`../context/TWO_ROOMS.md`](../context/TWO_ROOMS.md) -- [`20260703-202312_the-marked-value.md`](20260703-202312_the-marked-value.md)
...
at the top of a page, a mark on a value at a seam -- each is a small, hard,
checkable thing, and the row exists to keep such things small, hard, and
checkable. The other four rows reason, move, ignite, and flow; this row supplies
the ground they do it on. Mercury is the scribe planet in the old scheme, and
the row keeps that office plainly: it teaches the lap its ground, once per
orbit, from documents whose facts are already written down and already
checkable -- the safest ground a lap can stand on.

## The sense: aroma

Earth's sense is aroma -- the tanmatra of aroma, seated on the maintainer's word
...
The row speaks in six words, three light and three dark, drawn from the two
fifteen-seat palettes in kyri/receipt.rye (seated 20260826, paired seat for seat
under "dark euphoria, light terra"):

- **grain / mist** -- the cardinal pair. Grain initiates: the smallest piece a
  hand can hold -- a stamp, a token, a mark -- the concrete fact that seeds the
  lap. Mist is its night side: the same ground before it resolves into pieces,
  the state a fact is in before it is named.
- **aroma / incense** -- the fixed pair, and the row's own sense. Aroma is the
  concrete read at the door, the fact taken in whole before interpretation.
  Incense is the same sense turned deliberate, the reading a lap performs on
  purpose rather than receives in passing.
- **harvest / fallow** -- the dual pair. Harvest dissolves the lap onward: what
  a chapter of such readings gathers, turned toward the next orbit. Fallow is
  the same field resting -- the row between laps, holding its fertility without
  producing.
...
`context/TWO_ROOMS.md` seats the row's sustaining discipline: the checkable
room and the vision room, each named at the door. Only what a witness can bind
enters the checkable room as fact; orienting images keep their own strong voice
in the vision room; and a claim crosses between them by exactly one door -- it
earns a witness, and the crossing is recorded. From stamp 20260705.203144 the
...
## Dual: The Marked Value

`foundations/20260703-202312_the-marked-value.md` seats the row's adaptive
face: every value that crosses a seam wears a mark naming its type. A mark
keeps three duties -- absorb, express, tend -- and each conversion pair is
earned by a real crossing rather than built on speculation. Marks are values
in the weave, content-addressed like everything else, with exactly two
...
carried across seams, adapting its expression while keeping its name.

## The handoff

Earth is the fifth row, so its close is the rota's close, and the handoff
turns the grid back to aether. The motion is harvest into fallow into seed:
...
*May every stamp read true off the one clock, may every page say its room at
the door, and may every value cross its seam wearing its name -- so the ground
stays firm, the harvest gathers honestly, and the fallow field keeps its
quiet strength for the laps to come.*

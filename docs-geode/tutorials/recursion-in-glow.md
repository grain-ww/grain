...
**Naming note:** written for **Glow** and the **rune shell** surface; the rune shell's proper name awaits the maintainer's word (`context/specs/reserved-vocabulary.md`)

# sec -- carried into `shape/`

**Language:** EN
**Status:** Pointer -- this room's pedestals moved to [`../shape/`](../shape/README.md) on `20260827.184500`
**Molted:** `20260827.184500` -- on the maintainer's word, `approve all doors`
...
pedestals moved; **what this room taught about security and policy is carried whole** into

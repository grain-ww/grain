...
**Voice:** the maintainer’s letter, lightly tightened by Riyo  
...
Create a [GitHub](https://github.com) account (ideally the same username you want everywhere). Then ask Cursor to help you get set up with the instructions in the Grain root [`SOURCE.md`](../../SOURCE.md). Clone from **`https://github.com/acme-owner/grain.git`**. Codeberg is retired from this pier’s living push for now.

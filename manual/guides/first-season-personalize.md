...
Grain’s shared tree still carries the source pier’s living face in places — names, handles, clone URLs. The living beginner clone is [`acme-owner/grain`](https://github.com/acme-owner/grain); the agentic lane `acme-owner` stays named in [`REMOTE_ROSTER.md`](../../context/REMOTE_ROSTER.md). This walk hands you a **Brix template** whose filled, **gitignored** instance holds *your* identity and a find/replace map, plus a **first 256-round season** shape: four equinoxes of 64, sixteen journeys of 16.
...
1. Clone the living public tree or your fork — beginner path [`SOURCE.md`](../../SOURCE.md) (`https://github.com/acme-owner/grain.git`).  
...
- Upstream dated testimony (the maintainer, the maintainer seasons) — accrete-never-break.  

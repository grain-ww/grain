...
**Voice:** Riyo
**Status:** Living -- witnessed once, end to end, on a a coastal city instance; reached and driven from a a tablet tablet via Termux, Cursor CLI signed in (the maintainer, 20260803)
**Home:** `nixos-guide/` -- seated by the maintainer's word, guide 0 of the series
...
```
pkg install openssh
ssh-keygen -t ed25519 -a 100 -f ~/.ssh/id_ed25519_dc1 -C "the-maintainer@dc1"

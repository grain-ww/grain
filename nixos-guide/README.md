...
*A home for the cloud pier's documentation, seated by the maintainer's word. Each guide is one witnessed road, numbered in walking order and stamped like every dated artifact. The pier these guides stand is the horizon home for Comlink, Tablecloth, Murr Mycelium, and whatever networked craft follows -- so the series begins with the machine itself and hardens it before anything listens on it.*

**Language:** EN - **Style:** Gauge (see `../context/GAUGE_STYLE.md`)

| # | Guide | Status |
|---|-------|--------|
| 0 | `20260803-164117_0-standing-a-declared-pier.md` -- tablet to running NixOS pier in ten movements | Witnessed end to end (a coastal city instance); driven from a a tablet via Termux, Cursor CLI signed in |
...
See [`20260803-194743_virt-horizon-on-the-cloud-pier.md`](20260803-194743_virt-horizon-on-the-cloud-pier.md) -- no nested KVM on this a cloud provider guest; s6 packages for study; SixOS / Genode QEMU TCG parked; Framework owns proven-seat KVM.

...
**Stamp:** `20260707.011412 UDT` (the maintainer's clock)
**Language:** EN
...
| -- Weave (aspect) | Text-buffer line history under `diff.rye`; namespace "Weave" = metaphor for `BoltCatalog` accretion -- sovereign slice is I2 `catalog/` export (the maintainer `030412`) | `mantra/src/weave.rye` | graduation trigger when Comlink serves named data from Weave |

...
**Stamp:** `20260707.042512 UDT` (the maintainer's clock)
**Language:** EN
...
- **Live-instance continuity refusal** -- the maintainer gate (I7); do not extend placeholder check while touching import

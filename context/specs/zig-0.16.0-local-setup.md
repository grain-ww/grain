...
the maintainer wanted the Zig 0.16.0 stable source on hand, cloned from the Ziglang project on Codeberg, and arranged in a way that feels organized and entirely local. The deeper question was where the source belongs, given that we work inside the ai-jail sandbox.

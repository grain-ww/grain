...
the maintainer also asked to reify [`external-research/20260713-212900_self-hosted-vpn-cto-credential-security.md`](../../external-research/20260713-212900_self-hosted-vpn-cto-credential-security.md) -- turn the guide into something that actually runs, instructed with **Rish** (`.rish`). Split honestly by what each machine can do:

...
**Voice:** Quin  
**Status:** Seated (the maintainer’s align-and-run word on workshop/warehouse counsel)  
...
## The one exception, and why it is one (accretion `20260824.190000`, the maintainer's word)
...
(REDS %205). Raising this one page is the resolution the maintainer chose; lowering the room bound was the
other, and it would have cost the room its own ceiling rather than the index its own.

## The second exception -- the operator card (accretion `20260904.204611`, the maintainer's word)
...
### `construction/REDS.md` carries 40,960 too, raised `20260906.022428` on the maintainer's word
...
### Raised to 40,960 on the maintainer's word, `20260906.001901` -- and only one of the three parts moved

...
**Stamp:** `20260710.165634` (the maintainer: likes the name suggestions; open what is needed)
**Language:** EN
...
**Room:** mixed -- four laps landed with witnesses and parity pins; live TigerBeetle waits its own gate

...
2. **It is the newer, colliding entrant.** The Genode ladder's G0 dates to `20260712`; the GrapheneOS ladder's G0 was named five days later (`20260715.163500`), by an agent session that -- the maintainer's own words -- "was auto agent named without seeing the conflict." The later arrival yields to the incumbent.

...
**Stamp:** `20260707.024712 UDT` (the maintainer's clock)
**Language:** EN
**Style:** Gauge (see `../GAUGE_STYLE.md`)
**Status:** Seated -- lap 2 on metal; lap 1 grammar retained
**Room:** mixed -- lap 2 stands on metal; the continuity fact is a sketch rather than a bound check
...
Per counsel [`20260707-025212`](../counsel/20260707-025212_claude-counsel-weave-brix-pond-customs.md) and the maintainer's ruling [`20260707-030412`](../context/specs/20260707-030412_weave-slice-ruling.md):
...
- **Live-instance continuity refusal** -- the maintainer gate (I7); lap 2 only checks epoch != 0 and identity matches signer

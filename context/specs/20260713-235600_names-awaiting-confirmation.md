# Names Awaiting the maintainer's Confirm or Deny
...
Every row is a proposal, not a fact. Nothing here is renamed in the tree yet. the maintainer confirms or denies each; a confirmed name then migrates on-touch (living files) and cheapest-first (mass renames), per the fork's own rename discipline. This is the one page to return to when asking "what have we named but not yet settled?"

## Settled This Chapter (recorded, migration deferred)

| Name | Role | Status |
|---|---|---|
| **Glow** | the fused Rye-Hoon language | **Accepted** by the maintainer `20260713.225658` |

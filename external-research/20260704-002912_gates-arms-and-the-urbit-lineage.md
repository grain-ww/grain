...
| **door** | **Low** -- the maintainer doors, Urbit doors | Our **doors** are human rulings (`Door 1-3`); Urbit **door** is parameterized core -- different ledgers |
...
**Optional hygiene (the maintainer-gated):** one row in [`reserved-vocabulary.md`](../context/specs/reserved-vocabulary.md) holding **arm** and **door** (Hoon sense) as *study-only, never API*; a LEXICON cross-link under **Gate** pointing here for Urbit readers.

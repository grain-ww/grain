...
**Category:** External research -- survey and design study; recommends no dependency; every gate stays the maintainer's
...
**Status:** Proposed -- research for understanding, not advice; guest witness is a sketch; metal green waits on the maintainer's word and a machine that can hold the seat
...
*Written by Rio 3 for the maintainer - Seam season study 3.*
...
## Guest, Never Merger -- Stated as Law for This Chapter
...
| G0-G3 metal | Awaits the maintainer's word + a machine/image path |
| Study 4 | Still open |

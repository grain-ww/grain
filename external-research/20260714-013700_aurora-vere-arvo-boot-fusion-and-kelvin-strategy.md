...
the maintainer asked to confirm against the live Urbit blog, and then Tlon's and Zorp's own sites, rather than reason from memory. All three check out, and the facts they confirm are load-bearing for everything below:

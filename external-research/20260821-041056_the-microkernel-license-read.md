...
**Gate:** the per-component license read named in [`the microkernel target and the OS parity question`](20260817-185851_microkernel-target-and-the-os-parity-question.md), blind spot one -- **granted by the maintainer `20260821`**

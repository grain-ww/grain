...
If and when the maintainer gives the word to move from scoping to a first landed witness, the smallest-lovable-complete shape, matching this project's own SLC discipline:
...
- It does not decide the Hoon-runes-vs-TAME-bounds question -- it names the fork honestly and recommends a direction without deciding on the maintainer's behalf.

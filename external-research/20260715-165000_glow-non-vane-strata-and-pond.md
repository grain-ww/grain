...
- It does not rename anything; the strata are an architecture over the existing names, and every rename stays gated behind the maintainer's word per the mapping proposal.

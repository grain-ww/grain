...
*the maintainer asked for a writing that names what we mean by **Rye cores** -- the typed `.rye` body and the **Rishi** shell that witnesses it -- and compares that pattern honestly to the designs we study in `gratitude/`. This survey maps the homonyms, states what we adopt as concept, and leaves foreign words in the library rather than on our surface.*

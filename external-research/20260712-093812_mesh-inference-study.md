...
**Status:** Proposed study -- research for understanding; a shape to understand, not a seat to take. Every module role here is a sketch awaiting the maintainer's word and, for most rungs, a working seL4 seat first.

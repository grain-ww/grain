...
Three machines exist today -- a a cloud region VPS, a Framework laptop, and the macOS host this note was
...
|---|---|---|
| **3** (a cloud region + Framework + this Mac) | `(3-1)/3 = 0` | **zero** -- all three must vouch |
| 4 | `(4-1)/3 = 1` | one |
| 5 | `(5-1)/3 = 1` | one |
| 7 | `(7-1)/3 = 2` | two |

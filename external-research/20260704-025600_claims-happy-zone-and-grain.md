...
| Thin edge = devices, networks, hosts | Claims **narrow by metal** -- GNOME Wayland, localhost UDP, the maintainer's live five |
...
- `crossing_manifest_seed` parse green -- **do not claim** `crossing_manifest.rye` home until the maintainer seats it.

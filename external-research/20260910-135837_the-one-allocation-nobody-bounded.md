...
**Three questions belong to the maintainer rather than to a lap.**
...
**Waiting on the maintainer.** Whether Tally names `max_wakes` at all; whether it is counted or enforced;

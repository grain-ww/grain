...
**Research for understanding -- advice stays elsewhere.** Surveys and memos here frame understanding only -- they recommend no purchase, no treasury action, and no licensed professional course. Policy and money choices belong to the maintainer in their own chapter. Each dated exploration carries the boundary in its status line. Filing law: [`../ORGANIZING.md`](../ORGANIZING.md) - register law, seated and read on every cadence pass by [`../tools/t/two_rooms_doorway.rish`](../tools/t/two_rooms_doorway.rish): [`../context/TWO_ROOMS.md`](../context/TWO_ROOMS.md). That same status line names the room -- `research for understanding` where a page binds no witness, `mixed` where its numbers are witness-bound and its reading is proposed.
...
| Stamp | Note | Meaning |
|-------|------|---------|
| `20260909.072836` | [A retained reply needs its own bytes](20260909-072836_a-retained-reply-needs-its-own-bytes.md) | local buffer-reuse experiment; ownership before release |
...
| `20260801.132929` | [Clean-energy NixOS pier -- a cloud region / Mosh / Cursor CLI](20260801-132929_nixos-vps-clean-energy-mosh-cursor.md) | a cloud region = a datacenter (a region) hydro - 2 GB nixos-anywhere - cursor-cli + nix-ld - DC-1 Termux/Termius; research only -- purchase by the maintainer's hands |
...
| `20260710.000725` | [Learning chapter -- said plainly](20260710-000725_learning-chapter-plainly.md) | Civic education candidate in kitchen voice; canon wait remains the maintainer's |
...
| `20260706.005512` | [Settlement seat -- verification and verdict](20260706-005512_settlement-seat-verification-and-verdict.md) | Verifies the Sui pivot against neutral sources; grounds the Monad symmetry; raises settlement-asset integrity as a first-class axis; sourcing rule; softenings proposed, seat stays the maintainer's |
...
| `20260703-182612` | [Puddle -- the app harbor](20260703-182612_puddle-the-app-harbor.md) | a family member's blessing; harbor laps; charter expansion parked in RTAC |

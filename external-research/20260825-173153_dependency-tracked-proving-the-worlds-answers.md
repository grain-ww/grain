...
and the maintainer's word. Everything below serves it. The world's systems are read here to inform it.
...
the maintainer's ruling to make, not this note's. The expected hit rate of a whole-roster skip is also

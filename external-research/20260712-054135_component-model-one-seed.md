...
**Status:** Proposed -- research for understanding, not advice; one-seed pick is a design conclusion; compile lap waits on the maintainer's word
**Register:** checkable room for public Component Model / WIT claims; design-toward named as such

*Written by Rio 3 for the maintainer - Seam season study 2.*
...
Smallest checkable claim when the maintainer opens the compile door:
...
| Compile lap | Awaits the maintainer's word |

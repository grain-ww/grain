...
**Status:** Vision register -- design research; no code written, no module renamed; proposes roles for the maintainer to confirm
...
## What Stays Open (for the names spec and the maintainer's word)
...
- No code: this is the design; the first witness (the round-trip above) is the future implementation step, gated on the maintainer's word.

...
booked `20260907.074815` on the maintainer's word -- card row *Next, the ranked remainder*.
...
would be a different paper and would need a network fetch, a build, and the maintainer's word.
...
- **"Bakery rather than copal."** Killed by the maintainer's word, which outranks a roster reading.

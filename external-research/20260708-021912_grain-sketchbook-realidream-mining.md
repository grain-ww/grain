...
**Stamp:** `20260708.021912 UDT` (the maintainer's clock)
**Voice:** Rio 3 - **Model:** Fable 5 Max
**Language:** EN
**Style:** Gauge (see `../context/GAUGE_STYLE.md`)
**Category:** Source-of-inspiration study -- the source is the maintainer's own archived project (`grain-sketchbook`, Zig 0.15.2 era, ~168k lines, built across a long Cursor span), read the way this tree reads external teachers

...
- **Advising on a decision this project is about to make** -> `counsel/` (analysis, ruling, proposal, or recommendation -- awaiting the maintainer's word).

...
**Seated:** `20260811` on the maintainer's word - **Status:** Living - **Kin:** [`radiant-style.md`](radiant-style.md) - [`kyri.md`](kyri.md)
...
- **Ordinary and technical pieces** end plainly -- a red's repair, a small witness, a terse status. Radiant Style's own guidance holds: spend the benediction only where earned; an unearned wish cheapens the earned ones (`active-designing/yonder/date/20260715/20260715-163000_radiant-style-self-critique-benediction-vocabulary-ornament.md`).
...
The wish is where Radiant prose remembers who it is for. the maintainer asked that earned prose keep ending this way -- a warm, honest close that leaves a reader glad they came. Canonical Cursor twin: `.cursor/rules/radiant-wishes-ending.mdc`.

...
**Full guide:** `context/TWILIGHT_STYLE.md` - **Seated:** `20260811` on the maintainer's word - **Status:** Living - **Sibling of** `radiant-style.md`.
...
- **Fifteen across the sky; nine over twenty-seven.** The palette grew nine -> fifteen (`20260811`, the maintainer's word) to match the **sky fractal `3-9-15-27`**; the original nine still double as nine navamsa (D9) groups of three across the 27 nakshatras / council d27 -- dharma-essence per group. Calendar tie: `context/TWILIGHT_STYLE.md`.

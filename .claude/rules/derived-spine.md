...
**Seated:** `20260827.181605` on the maintainer's word - **Status:** Living - **Kin:** [`reds-first`](reds-first.md) - [`stamp-and-name`](stamp-and-name.md) - [`git-signing`](git-signing.md) (*the `%` sigil*) - [`collaboration`](collaboration.md)
...
**The resolution itself waits on the maintainer's word**, and the measurement is here for when it comes:
...
and source-file halves of the same root, and both stay the maintainer's word. This closes the ledger half.

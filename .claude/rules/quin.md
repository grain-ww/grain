...
- **The inference vane** -- the host gathering **Lattice - Scribble - Lantern -
  Kiln** under one name. **That host is named Ember** from `20260827` on the maintainer's
  ...
  eleven days, is retired. Quin keeps the seat it held; the vane keeps the name it
  earned. An ember is light *kept* where a lumen is light *described*.

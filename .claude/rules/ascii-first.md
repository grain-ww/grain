...
**Seated:** `20260816.214652` on the maintainer's word - **Status:** Living - **Kin:** [`reds-first`](reds-first.md) - [`standfast`](../../foundations/20260816-214652_standfast-the-stopped-line.md) - REDS %83
...
swept, re-poured, or retired governs a family and wants the maintainer's word, which is the standfast
...
Plain ASCII survives every tool, terminal, diff, and re-encoding intact. the maintainer asked that documents and commits prioritize it after the operator card corrupted itself in the dark. Canonical Cursor twin: `.cursor/rules/ascii-first.mdc`.

...
**Full guide:** [`../../context/GAUGE_STYLE.md`](../../context/GAUGE_STYLE.md) - **Seated:** `20260823.045448` on the maintainer's word - **Status:** Living
...
The sibling that has guarded these files since `20260821`,
...
- **Every figure carries unit, date, and source.** A number without those three is a rumour with
  a decimal point.
- **And a fifth thing: what holds it still.** A stamp says when a figure was read, never that the
  reading stands. **Pinned** (a submodule at a fixed commit) -- cite the number. **Walled** (a guard
  reds the lap it moves) -- cite the guard beside it. **Free** (nothing holds it) -- name the command
  and say RUN rather than READ. Measured `20260908.041006` over eight stamped claims in living law:
  every stale figure was free, every held figure pinned or walled, no exception.
...
Moving the living documents into their right setting is a **standfast** awaiting the maintainer's word,
